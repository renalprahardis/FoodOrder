package id.project.materialintroscreen;
...
import id.project.materialintroscreen.animations.wrappers.BackButtonTranslationWrapper;
import id.project.materialintroscreen.animations.wrappers.NextButtonTranslationWrapper;
import id.project.materialintroscreen.animations.wrappers.PageIndicatorTranslationWrapper;
import id.project.materialintroscreen.animations.wrappers.SkipButtonTranslationWrapper;
import id.project.materialintroscreen.animations.wrappers.ViewPagerTranslationWrapper;
import id.project.materialintroscreen.listeners.IFinishListener;
import id.project.materialintroscreen.listeners.IPageScrolledListener;
import id.project.materialintroscreen.listeners.IPageSelectedListener;
import id.project.materialintroscreen.listeners.MessageButtonBehaviourOnPageSelected;
import id.project.materialintroscreen.listeners.ViewBehavioursOnPageChangeListener;
import id.project.materialintroscreen.listeners.clickListeners.PermissionNotGrantedClickListener;
import id.project.materialintroscreen.listeners.scrollListeners.ParallaxScrollListener;
import id.project.materialintroscreen.widgets.InkPageIndicator;
import id.project.materialintroscreen.widgets.OverScrollViewPager;
import id.project.materialintroscreen.widgets.SwipeableViewPager;
